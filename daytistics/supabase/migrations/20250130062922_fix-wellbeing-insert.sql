...
ALTER TABLE
    "public"."daytistics" OWNER TO "postgres";
...
ALTER TABLE
    "public"."diary_entries" OWNER TO "postgres";
...
ALTER TABLE
    "public"."wellbeings" OWNER TO "postgres";
...
ALTER TABLE
    ONLY "public"."diary_entries"
ADD
    CONSTRAINT "diary_entries_pkey" PRIMARY KEY ("id");

ALTER TABLE
    ONLY "public"."wellbeings"
ADD
    CONSTRAINT "wellbeings_pkey" PRIMARY KEY ("id");
...
ALTER TABLE
    ONLY "public"."daytistics"
ADD
    CONSTRAINT "daytistics_diary_entry_id_fkey" FOREIGN KEY ("diary_entry_id") REFERENCES "public"."diary_entries"("id") ON DELETE CASCADE;

ALTER TABLE
    ONLY "public"."daytistics"
ADD
    CONSTRAINT "daytistics_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "auth"."users"("id") ON DELETE CASCADE;

ALTER TABLE
    ONLY "public"."daytistics"
ADD
    CONSTRAINT "daytistics_wellbeing_id_fkey" FOREIGN KEY ("wellbeing_id") REFERENCES "public"."wellbeings"("id") ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED;
...
CREATE POLICY "Users can delete their own diary entries" ON "public"."diary_entries" FOR DELETE USING (
    (
        "auth"."uid"() = (
            SELECT
                "daytistics"."user_id"
...
CREATE POLICY "Users can delete their own wellbeings" ON "public"."wellbeings" FOR DELETE USING (
    (
        "auth"."uid"() = (
            SELECT
                "daytistics"."user_id"
